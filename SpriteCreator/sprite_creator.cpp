...
/*
	// PELIHAHMOT
	luo_prototyyppi_kukko(				"sprites\\rooster.spr");	// p�ivitetty - update 1!
	luo_prototyyppi_kukko_kynitty(		"sprites\\r_naked.spr");	// p�ivitetty - update 1!
	...
	luo_prototyyppi_kani(				"sprites\\rabbit.spr");		//��net p�ivitetty - update 2!
	luo_prototyyppi_kani2(				"sprites\\rabbit2.spr");	//��net p�ivitetty - update 2!
...
/*	luo_prototyyppi_possu(				"sprites\\pig.spr");
	...
	luo_prototyyppi_jattihiiri2(		"sprites\\gmouse2.spr"); // p�ivitetty - update 1!
...
/*
	...
	luo_prototyyppi_avain4(				"sprites\\key4.spr");	// p�ivitetty - update 2
	...
	// TAUSTASPRITET
	luo_prototyyppi_tausta_kukka1(		"sprites\\bg_flwr1.spr");	// p�ivitetty - update 1!
	...
	luo_prototyyppi_perhonen(			"sprites\\bttrfly.spr");	// p�ivitetty - update 1!
	luo_prototyyppi_perhonen2(			"sprites\\bttrfly2.spr");	// p�ivitetty - update 1!
	luo_prototyyppi_perhonen3(			"sprites\\bttrfly3.spr");	// p�ivitetty - update 1!
...
/*
	...
	*/
	...
	luo_prototyyppi_sammakko4(			"sprites\\frog4.spr");		//uusi! - update 2!
	luo_prototyyppi_sammakko5(			"sprites\\frog5.spr");		//uusi! - update 2!
	luo_prototyyppi_hyppija(			"sprites\\jumper.spr");		//��net p�ivitetty - update 2!
	luo_prototyyppi_hyppija2(			"sprites\\jumper2.spr");	//��net p�ivitetty - update 2!
	luo_prototyyppi_kani(				"sprites\\rabbit.spr");		//��net p�ivitetty - update 2!
	luo_prototyyppi_kani2(				"sprites\\rabbit2.spr");	//��net p�ivitetty - update 2!
	luo_prototyyppi_pommi(				"sprites\\bomb.spr");	// p�ivitetty - update 2!
	luo_prototyyppi_jattihiiri2(		"sprites\\gmouse2.spr"); // p�ivitetty - update 1!
	luo_prototyyppi_mehilainen3(		"sprites\\bee3.spr");	// uusi - update 1!
	luo_prototyyppi_tankki1(			"sprites\\tank.spr");	//��net p�ivitetty - update 2!
	luo_prototyyppi_tankki2(			"sprites\\tank2.spr");	//��net p�ivitetty - update 2!
	luo_prototyyppi_tankki3(			"sprites\\tank3.spr");	//��net p�ivitetty - update 2!	
	luo_prototyyppi_tankki4(			"sprites\\tank4.spr");	//��net p�ivitetty - update 2!
	luo_prototyyppi_pahakana2(			"sprites\\evilone2.spr"); // uusi - update 2!
	luo_prototyyppi_jattimehilainen(	"sprites\\gbee.spr");	// uusi - update 2!
	luo_prototyyppi_robokana(			"sprites\\robohen.spr"); // uusi - update 2!
	luo_prototyyppi_robokanan_paa(		"sprites\\robohead.spr"); // uusi - update 2!
