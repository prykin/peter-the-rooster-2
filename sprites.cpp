...
int PK2Sprite::AI_Teleportti(int oma_i, PK2Sprite *spritet, int max, PK2Sprite &sprite)
{
	...
	if (energia > 0 && lataus == 0 && hyokkays1 == 0)
	{
		...
		{	
			...
			// jos yht��n samantyyppist� ei l�ydy...
			if (porttien_maara == 0)
			{
			...
			// jos viel�k��n ei l�ydy yht��n teleporttia (poislukien teleportti itse), poistutaan.
			if (porttien_maara <= 1)
				return 0;
...
int PK2Sprite::AI_Teleportti(int oma_i, PK2Sprite *spritet, int max, PK2Sprite &pelaaja)
{
	...
	if (energia > 0 && lataus == 0 && hyokkays1 == 0)
	{
		UCHAR todnak = 100; // todenn�k�isyys tulla valituksi kohdeteleportiksi
