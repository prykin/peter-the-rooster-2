...
//  */
//
// typedef struct MIDASmodule;
// typedef struct MIDASmodulePlayHandle;
//
// bool MIDASloadConfig(const char * str);
// bool MIDASconfig();
// void MIDASsaveConfig(const char * str);
// void MIDASstartup();
// void MIDASsetOption(int midas_option_dsound_hwnd, unsigned long window_handle);
// void MIDASinit();
// void MIDASstartBackgroundPlay(int i);
// void MIDASstopBackgroundPlay();
// void MIDASclose();
// void MIDASstopModule(MIDASmodulePlayHandle play_handle);
// void MIDASfreeModule(MIDASmodule module);
// MIDASmodulePlayHandle MIDASplayModule(MIDASmodule module, bool cond);
// void MIDASloadModule(const char * str);
// void MIDASsetMusicVolume();
//
// int MIDAS_OPTION_DSOUND_HWND;
// int MIDAS_OPTION_DSOUND_MODE;
// int MIDAS_DSOUND_FORCE_STREAM;
// int MIDAS_OPTION_DSOUND_OBJECT;
//
// #define WINAPI
...
//     // HICON     hIconSm;
// } WNDCLASSEX, WNDCLASSEXA, *PWNDCLASSEXA, *NPWNDCLASSEXA, *LPWNDCLASSEXA;
//
// #if defined(_WIN64)
