...
----------
		...
		Kontrollit = n�pp�imist�n, hiiren tai peliohjaimen luku yhdell� aliohjelmalla 
		  
		Lis�tty vakiokontrollit (esimerkkej�: PI_KB_A, PI_KB_UP, PI_HIIRI_VASEN_NAPPI, PI_PELIOHJAIN1_NAPPI_1)
		Mahdollistavat sen, ett� k�yttj� voi valita itse kontrollit. Selkeytt�� my�s koodia.

UCHAR	PisteInput_Lue_Kontrolli();
		Kertoo mink� kontrollin pelaaja on valinnut.

bool	PisteInput_Lue_Kontrolli(UCHAR kontrolli); // Palauttaa TRUE jos k�ytt�j� on aktivoinut kontrollin.
		Kertoo onko pelaaja painanut kontrollia (hiiren nappi, peliohjaimen nappi tai n�pp�in) 
